...
// Second team member name : Danish Waheed
	...
	To compile and run the Virtual Machine mainfp.c, the user can
enter to a terminal window gcc mainfp.c -o extensionName to compile the .c file
...
screen that it has finished. The output files will be located on the same folder as the mainfp.c file.  If the program encounters an error along the process, it will terminate
